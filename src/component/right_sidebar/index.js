      ...
      <>
        ...
        <div className='rgt_side w-full h-screen bg-semi-white p-5 relative'>
          <ul className='space-y-3'>
            ...
            <li><button onClick={() => handleRightsidebar('your-friend')} className='font-poppin font-semibold text-sm text-semi-black'>All Friends <span className='...'>45</span></button></li>
            ...
            <li><button onClick={() => handleRightsidebar('your-group')} className='font-poppin font-semibold text-sm text-semi-black'>All Groups <span className='...'>25</span></button></li>
            ...
            <li><button onClick={() => handleRightsidebar('block-users')} className='font-poppin font-semibold text-sm text-semi-black'>Block Users <span className='...'>25</span></button></li>
          </ul>
        </div>
      </>
    :
